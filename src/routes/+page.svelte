...
<div>
  <img src="/logo.png" />
  <!-- <a
    href="https://form.jotform.com/233385613498062
  ">Sign up here</a
  > -->
  <!-- <a
    href="https://form.jotform.com/233385613498062
  ...
  > -->
  <iframe
    id="JotFormIFrame-233385613498062"
    title="Form"
    onload="window.parent.scrollTo(0,0)"
    allowtransparency="true"
    allowfullscreen="true"
    allow="geolocation; microphone; camera"
    src="https://form.jotform.com/233385613498062"
    frameborder="0"
  ...
  <script type="text/javascript">
    var ifr = document.getElementById('JotFormIFrame-233385613498062');
    if (ifr) {
      var src = ifr.src;
      var iframeParams = [];
